...
MARTEX-Project/MARTEX repository.
...
Setup
---------
Configuring the github-merge tool for the MARTEX repository is done in the following way:

    git config githubmerge.repository MARTEX-Project/MARTEX
...
A script to optimize png files in the MARTEX
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_martex: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_martex: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_martex: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_martex: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
