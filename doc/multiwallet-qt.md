...
In order to support loading of multiple wallets in martex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is martex.cpp.
...
Changes to martex.cpp
----------------------
martex.cpp is the entry point into martex-qt, and as such, will require some minor modifications to provide hooks for
