...
!else
InstallDir $PROGRAMFILES\MarteX
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "MarteX"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\martex-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\MarteX (testnet, -bit).lnk" "$INSTDIR\martex-qt" "-testnet" "$INSTDIR\martex-qt" 1
    ...
    WriteRegStr HKCR "martex" "URL Protocol" ""
    WriteRegStr HKCR "martex" "" "URL:MarteX"
    WriteRegStr HKCR "martex\DefaultIcon" "" $INSTDIR\martex-qt
    WriteRegStr HKCR "martex\shell\open\command" "" '"$INSTDIR\martex-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\martex-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\MarteX (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\MarteX.lnk"
