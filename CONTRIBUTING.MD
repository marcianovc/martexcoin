Contributing to MarteX
============================

The MarteX project operates an open contributor model where anyone is
...
The following applies to code changes to the MarteX project, and is not to be
confused with overall MarteX Network Protocol consensus changes.

Whether a pull request is merged into MarteX rests with the project merge
...
The project leader is the release manager for each MarteX release.
