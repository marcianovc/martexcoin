...
pkgdatadir = $(datadir)/martex
pkgincludedir = $(includedir)/martex
pkglibdir = $(libdir)/martex
pkglibexecdir = $(libexecdir)/martex
...
CONFIG_HEADER = $(top_builddir)/src/config/martex-config.h
...
ACLOCAL = ${SHELL} /home/marciano/martexcoin_2.8.x/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/marciano/martexcoin_2.8.x/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/marciano/martexcoin_2.8.x/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/marciano/martexcoin_2.8.x/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = martex-cli
BITCOIN_DAEMON_NAME = martexd
BITCOIN_GUI_NAME = martex-qt
BITCOIN_TX_NAME = martex-tx
...
CPPFLAGS = -I/home/marciano/martexcoin_2.8.x/db4/include/ -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2
CRYPTO_CFLAGS = 
CRYPTO_LIBS = -lcrypto
CXX = g++
CXXCPP = g++ -E
...
LDFLAGS = -L/home/marciano/martexcoin_2.8.x/db4/lib/  -Wl,-z,relro -Wl,-z,now
LEVELDB_CPPFLAGS = 
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/marciano/martexcoin_2.8.x/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = martex
PACKAGE_BUGREPORT = martexcoin.org
PACKAGE_NAME = MarteX
PACKAGE_STRING = MarteX 2.8.0
PACKAGE_TARNAME = martex
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/marciano/martexcoin_2.8.x
abs_srcdir = /home/marciano/martexcoin_2.8.x
abs_top_builddir = /home/marciano/martexcoin_2.8.x
abs_top_srcdir = /home/marciano/martexcoin_2.8.x
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/marciano/martexcoin_2.8.x/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_martex_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_martex_coverage.info test_martex.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MarteX-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/martex-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/martex-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/martex-config.h
$(top_srcdir)/src/config/martex-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/martex-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/MarteX-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(OSX_DMG): $(OSX_APP_BUILT) $(OSX_PACKAGING) contrib/macdeploy/$(OSX_BACKGROUND_IMAGE)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MarteX-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MarteX-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_martex.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_martex -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_martex_filtered.info: test_martex.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_martex_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_martex_coverage.info: baseline_filtered_combined.info test_martex_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_martex_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_martex_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_martex_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_martex.coverage/.dirstamp:  test_martex_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_martex.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_martex.coverage/ total.coverage/ $(OSX_APP)
