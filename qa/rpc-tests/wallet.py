...
#   c) node1 mines 32 blocks, so now node 0 has 60001mxt, node 1 has 4250mxt, node2 has none.
#   d) node0 sends 601 mxt to node2, in two transactions (301 mxt, then 300 mxt).
