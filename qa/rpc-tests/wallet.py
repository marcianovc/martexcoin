...
#   c) node1 mines 32 blocks, so now node 0 has 60001 martex, node 1 has 4250 martex, node2 has none.
#   d) node0 sends 601 martex to node2, in two transactions (301 martex, then 300 martex).
