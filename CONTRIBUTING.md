Contributing to MARTEX Core
============================

The MARTEX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MARTEX Core project, and is not to be
confused with overall MARTEX Network Protocol consensus changes.

Whether a pull request is merged into MARTEX Core rests with the project merge
...
Patches that change MARTEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the MARTEX consensus, it must have been
...
The project leader is the release manager for each MARTEX Core release.
