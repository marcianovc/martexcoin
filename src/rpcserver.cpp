...
#ifdef ENABLE_WALLET
        {"martex", "anonsend", &anonsend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use martexd, or the -server option to martex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
