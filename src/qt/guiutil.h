...
/** Utility functions used by the MARTEX Qt UI.
 */
namespace GUIUtil
{
...
// Render MARTEX addresses in monospace font
...
// Parse "martex:" URI into recipient object, return true on successful parsing
