                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMXTPathCustom = GetArg("-zmxtbackuppath", "");
    ...
    if(!strzMXTPathCustom.empty()) {
        ui->wallet_customzmxtbackuppath->setText(QString::fromStdString(strzMXTPathCustom));
        ui->wallet_customzmxtbackuppath_label->setVisible(true);
        ui->wallet_customzmxtbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMXTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MARTEX RPC console.") + "<br>" +
