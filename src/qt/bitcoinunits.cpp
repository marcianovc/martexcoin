...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MXT:
            return QString("tMXT");
        case mMXT:
            return QString("mtMXT");
        case uMXT:
            return QString::fromUtf8("μtMXT");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MXT:
            return QString("MXT");
        case mMXT:
            return QString("Milli-MXT (1 / 1" THIN_SP_UTF8 "000)");
        case uMXT:
            return QString("Micro-MXT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        ...
        case uMXT:
            return QString("Micro-TestMXT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
