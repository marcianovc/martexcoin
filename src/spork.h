...
#define SPORK_2_FASTTX_DEFAULT 978307200                         //2001-1-1
#define SPORK_3_FASTTX_BLOCK_FILTERING_DEFAULT 1424217600        //2015-2-18
#define SPORK_5_MAX_VALUE_DEFAULT 1000                            //1000 MXT
...
public:
    ...
    uint256 GetHash()
    {
        uint256 n = X13Hash(BEGIN(nSporkID), END(nTimeSigned));
        return n;
    }
