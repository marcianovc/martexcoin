...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MARTEX features */
        {"martex", "masternode", &masternode, true, true, false},
        {"martex", "listmasternodes", &listmasternodes, true, true, false},
        {"martex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"martex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"martex", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"martex", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"martex", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"martex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"martex", "masternodedebug", &masternodedebug, true, true, false},
        {"martex", "startmasternode", &startmasternode, true, true, false},
        {"martex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"martex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"martex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"martex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"martex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"martex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"martex", "mnbudget", &mnbudget, true, true, false},
        {"martex", "preparebudget", &preparebudget, true, true, false},
        {"martex", "submitbudget", &submitbudget, true, true, false},
        {"martex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"martex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"martex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"martex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"martex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"martex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"martex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"martex", "checkbudgets", &checkbudgets, true, true, false},
        {"martex", "mnsync", &mnsync, true, true, false},
        {"martex", "spork", &spork, true, true, false},
        {"martex", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmxtseed", &getzmxtseed, false, false, true},
        {"zerocoin", "setzmxtseed", &setzmxtseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmxt", &searchdzmxt, false, false, true},
        {"zerocoin", "dzmxtstate", &dzmxtstate, false, false, true}
...
{
    return "> martex-cli " + methodname + " " + args + "\n";
}
