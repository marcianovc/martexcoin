...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"zMXTsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zMXT denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zMXT denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zMXT denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zMXT denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zMXT denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zMXT denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zMXT denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zMXT denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zMXT denominations\n"
            "  }\n"
    ...
    UniValue zmxtObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zmxtObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zmxtObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zMXTsupply", zmxtObj));
