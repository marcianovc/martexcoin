...
extern UniValue setzmxtseed(const UniValue& params, bool fHelp);
extern UniValue getzmxtseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmxt(const UniValue& params, bool fHelp);
extern UniValue dzmxtstate(const UniValue& params, bool fHelp);
